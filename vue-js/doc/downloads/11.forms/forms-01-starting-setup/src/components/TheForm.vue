<script>
import RatingCotrol from "@/components/RatingCotrol";
export  default {
  components: {RatingCotrol},
  props: ['modelValue'],
...
<template>
  <form @submit.prevent="submitFormData">
    <div class="form-control" :class="{invalid: userNameValidity==='invalid'}">
      ...
      <input id="user-name" name="user-name" type="text" v-model.trim="userName" placeholder="user name" @blur="validateInput"/>

    </div>
    <div class="form-control">
      <label for="age">Your Age (Years)</label>
      <input id="age" name="age" type="number" v-model="userAge" ref="ageInput" placeholder="your age" @blur="validateInput"/>
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
      <input id="confirm-terms" name="confirm-terms" type="checkbox"  value="Terms"  v-model="confirmTerms" />
      <label for="confirm-terms">Agree to terms of use?</label>
    </div>
    <div class="form-control">
      <rating-cotrol v-model="rating"></rating-cotrol>
    </div>
    <div>
